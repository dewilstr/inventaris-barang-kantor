<?php 
    ...
    if (isset($_POST['btnSearch'])) {
        ...
        $param      = $_POST['dateAwal'] ?? null;
        $param1     = $_POST['dateAkhir'] ?? null;
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <input 
                                            value="<?= htmlspecialchars($_POST['dateAwal'] ?? '') ?>" 
                                            class="form-control" 
                                            type="date" 
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input 
                                            value="<?= htmlspecialchars($_POST['dateAkhir'] ?? '') ?>" 
                                            class="form-control" 
                                            type="date" 
                                            placeholder="Select Date" 
                                            name="dateAkhir" 
                                ...
                                <?php if ($param && $param1): ?>
                                    <a target="_blank" 
                                       href="manager/BarangPeriodePrint.php?dateAwal=<?= $param ?>&dateAkhir=<?= $param1 ?>"  
                                ...
                                <table class="table table-striped table-hover table-bordered">
                                    ...
                                    <tbody>
                                        <?php if (!empty($dataB['data']) && count($dataB['data']) > 0): ?>
