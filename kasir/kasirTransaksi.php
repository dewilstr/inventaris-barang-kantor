...
$sql2 = "SELECT COUNT(kd_pretransaksi) as count 
         FROM table_pretransaksi 
         WHERE kd_transaksi = '$transkode'";
...
if (isset($_POST['btnAdd'])) {
    ...
    if ($kd_transaksi == "" || $barang == "" || $jumlah == "" || $total == "") {
        ...
        if ($jumlah < 1) {
            ...
            if ($sisa['stok_barang'] < $jumlah) {
                ...
                $sql = "SELECT * FROM table_pretransaksi 
                        WHERE kd_transaksi = '$kd_transaksi' 
                        AND kd_barang = '$barang'";
                $exe = mysqli_query($con,$sql);
                $num = mysqli_num_rows($exe);
                $dta = mysqli_fetch_assoc($exe);

                if ($num > 0) {
                    $jumlahBaru = $dta['jumlah'] + $jumlah;
                   $kd_pre = $trans->autokode("table_pretransaksi", "kd_pretransaksi", "PR");

$kd_pre = $trans->autokode("table_pretransaksi", "kd_pretransaksi", "PR");
$trans->insertPreTransaksi($kd_pre, $kd_transaksi, $barang, $jumlah, $total);
header("location:pageKasir.php?page=kasirTransaksi");
exit;
                    header("location:pageKasir.php?page=kasirTransaksi");
                } else {
                    $kd_pretransaksi = $trans->autokode("table_pretransaksi","kd_pretransaksi","PR");
                    $kd_pretransaksi = $trans->autokode("table_pretransaksi", "kd_pretransaksi", "PR");
$trans->insertPreTransaksi($kd_pretransaksi, $kd_transaksi, $barang, $jumlah, $total);
header("location:pageKasir.php?page=kasirTransaksi");
exit;
                            ...
                            <form method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input style="font-weight: bold; color: red;" 
                                               type="text" class="form-control" 
                                               value="<?= $transkode; ?>" 
                                               readonly name="kd_transaksi">
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <a class="btn btn-primary btn-block" 
                                                       href="#fajarmodal" data-toggle="modal">
                                                       Pilih Barang</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" 
                                                   name="harba" 
                                                   value="<?php echo @$dataR['harga_barang']; ?>" 
                                                   id="harba" readonly>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" 
                                                   name="total" readonly id="totals">
                                        </div>
                                        <button class="btn btn-primary" name="btnAdd">
                                            <i class="fa fa-cart-plus"></i> Tambahkan ke Antrian
                                        </button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php if ($assoc2['count'] > 0 || isset($_POST['btnAdd'])): ?>  
                                <a class="btn btn-success" id="pembayaran" href="?page=kasirPembayaran">
                                    Lanjutkan ke pembayaran <i class="fa fa-cart-arrow-down"></i>
                                </a>
                            <?php endif ?>
                            <br><br>
                            <?php
                                ...
                                $datas     = $kr->querySelect("
                                    SELECT p.kd_pretransaksi, b.nama_barang, p.jumlah, p.sub_total
                                    FROM table_pretransaksi p
                                    JOIN table_barang b ON p.kd_barang = b.kd_barang
                                    WHERE p.kd_transaksi = '$transkode'
                                ");
                                $sql       = "SELECT SUM(sub_total) as sub 
                                              FROM table_pretransaksi 
                                              WHERE kd_transaksi = '$transkode'";
                                ...
                                if (count($datas) > 0) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="?page=kasirTransaksi&delete&id=<?= $dd['kd_pretransaksi']; ?>" 
...
<!-- MODAL PILIH BARANG -->
<div class="modal fade" id="fajarmodal" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                <table class="table table-hover table-bordered" id="sampleTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="pageKasir.php?page=kasirTransaksi&getItem&id=<?php echo $brs['kd_barang'] ?>">
                                <?php echo $brs['kd_barang'] ?></a></td>
