...
/* Container ditengah & full-screen */
.login-wrap {
    display: flex;
...
/* Box putih login */
.login-content {
    padding: 20px 30px !important;  /* diperkecil */
    border-radius: 20px;
    width: 420px;                   /* biar pas */
    max-height: 90vh;               /* biar ga kepanjangan */
    overflow: hidden;               /* biar isi ga keluar */
}

/* Logo jaraknya dikecilin */
.login-logo {
 margin-top: -40px !important;  /* geser ke atas */
 margin-bottom: 5px !important; /* rapatin ke form */}
...
/* Checkbox remember me lebih rapat */
.login-checkbox {
    margin-top: -5px !important;
    margin-bottom: 5px !important;
}

/* Tombol login rapat ke atas */
.au-btn--block {
    margin-top: 5px !important;
}
